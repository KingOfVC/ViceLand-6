class CLogin extends CContext
{
	...
	//	this.Background.Colour = Colour( 0, 0, 0, 155 );
		...
		this.Titlebar.SetTexture( "login-bg.png" );
		...
		this.Inputbox.Text = "";
		this.Inputbox.FontSize = ( rel.X * 0.0130208333333333 );
		...
		this.ButtonText.TextColour = Colour( 255, 255, 0, 0 );
	...
	function onElementHoverOver( element )
	{
		switch( element )
		{
			...
			this.ButtonText.TextColour = Colour( 66, 70, 0 );
			break;
		}
	}
	...
	function onElementHoverOut( element )
	{
		switch( element )
		{
		    ...
		    this.Button.Colour = Colour( 246, 123, 78, 0 );
			this.ButtonText.TextColour = Colour( 255, 255, 0 );
			break;
		}
	}
